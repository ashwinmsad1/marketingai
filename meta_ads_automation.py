...
class MetaUserProfile:
    ...
    # Enhanced Business Information for Meta Personalization
    ...
    competitor_audiences: List[str] = field(default_factory=list)  # Competitor page followers
...
class MetaAdsPersonalizationEngine:
    ...
    def _parse_business_context(self, query: str) -> Dict[str, Any]:
        ...
        # Budget detection
        budget = None
        budget_patterns = [r'\$(\d+(?:,\d+)?)', r'(\d+)\s*(?:dollar|USD)']
...
async def fitness_studio_demo():
    ...
    Example: Local fitness studio owner with $1000/month budget wanting gym memberships
    """
    ...
    user_query = "I'm a local fitness studio owner with a $1000/month budget. What Meta campaign strategy should I use to get more gym memberships?"
    ...
    try:
        ...
        print("This strategy is specifically tailored for your fitness studio to maximize gym membership leads within your $1000/month budget.")
...
async def main():
    ...
    if choice == "6":
        ...
        if not user_query:
            user_query = "I run a restaurant and want to increase dinner reservations with a $800/month budget"
